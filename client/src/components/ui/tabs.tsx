...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-base border-2 border-border bg-white/30 p-1 text-text dark:border-darkBorder",
      className,
    )}
    {...props}
  />
